...
|---|---:|---:|---:|---:|---|
| 2025-01-SECOND … 2026-04-FIRST (28 quincenas) | n/a | n/a | n/a | n/a | Sin cambios |
...
|---|---|---|---|
| `Berna`, `Bernardo` | **Bernardo** | ninguna | ninguna |
| `Didi`, `Didi Card`, `Didi tarjeta` | **DiDi** | ninguna | ninguna |
| `David` (14×), `David Abril/Febrero/Marzo/Mayo`, `David Febrero y 3000 Marzo`, `Inscripcion David` | **Escuela David** | categoría = ESCUELA.DAVID | ninguna |
| `Santiago`, `Santiago+mes`, `Santi Junio/Mayo`, `Santiago inscripción`, `Inscripcion Santi`, `Libro Santi` | **Escuela Santiago** | categoría = ESCUELA.SANTIAGO | ninguna |
| `Pau` (mesada 17×), `inscripción Pau` | **Escuela Pau** | categoría = ESCUELA.PAU | ninguna |
| `Pau` ($800 en OTHERS), `Pau Raul` ($500) | **Pau** | categoría = TRANSFERENCIAS_FAMILIARES.PAU | Pau Raul: "gasto de Pau; Raúl es su novio" |
| `Hawainano` (typo) | **Hawaiano** | ninguna | ninguna |
| `Diversion` (sin tilde, 8×) | **Diversión** | ninguna | ninguna |
| `Cochecito` (17×) y `Gasolina chochecito` (19×) | **Gasolina Cochecito** | sección TRANSPORTATION | ninguna |
| `Cochecito` ($8,000 en OTHERS) | **Cochecito (servicio)** | sección OTHER | ninguna |
| `Prestamo Omar 3…10`, `Prestamo 1 Omar`, `Prestamo 2 (Omar)` | **Préstamo Omar** | ninguna | "pago N de la serie" |
| `Mercado Libre 1 de 12` / `7 de 12` | **Mercado Libre MSI** | ninguna | "pago N de 12" |
| `Buro de credito 1 de 3` / `2 de 3` | **Buró de Crédito** | ninguna | "pago N de 3" |
| `David` ($249 en HOUSING) | **Teléfono David** | categoría = OTHER.TELEFONO | ninguna |
| `Telefono David/Norma/Santi/Benji/Pau` | **Teléfono David/Norma/Santi/Benji/Pau** (con tilde) | ninguna | ninguna |
