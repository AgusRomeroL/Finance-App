...
| 26 | D | **Cerrado (2026-09-16).** Cero U+2014 es regla invariable y el repositorio llegó a versionar 1395 ocurrencias en 206 archivos. Los textos visibles y los comentarios Kotlin se barrieron en la Fase 6b y hoy `git grep` no encuentra una sola ocurrencia en ningún archivo versionado, documentación incluida. Queda para la Fase 7 la verificación automática en CI, que es lo que impide que vuelvan. | `git grep` del 2026-09-16, sin resultados | 6, 7 |
