...
| 6 | Mejora de UX con `/design` y accesibilidad | 1, 5 | 2 (6a auditoría y diseño; 6b implementación) | **hecha** (2026-09-16): auditoría, accesibilidad, textos, Quick Tap y los cuatro rediseños elegidos, verificados en FinanceFold con la configuración fiel. Sin publicar el sistema de diseño en la nube (`/design-sync` exige `/design-login`, que solo se concede desde una sesión interactiva) | `5859d87` (último de contenido; el cierre documental es el commit siguiente, que actualiza esta tabla) |
