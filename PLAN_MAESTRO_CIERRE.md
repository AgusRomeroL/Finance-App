...
| 7 | Calidad: pruebas, CI y observabilidad | 2, 5 | 1 | **hecha salvo observabilidad** (2026-09-17): 91 pruebas JVM, 10 instrumentadas (migraciones sobre el asset real desde v1, v16, v17 y v18, verificadas en el Pixel 7), 395 casos de reglas, 21 de la web, CI en `ci.yml` e `instrumented.yml`. La decisión 7 de §7 (Crashlytics o registro local) sigue en manos de Agustín; el barrido de rayas largas en la documentación queda pendiente | (el cierre documental es el commit que actualiza esta tabla) |
...
**Resultado (2026-09-17).** Puntos 1 a 5 hechos; el 6 queda abierto.
...
- *Observabilidad*: sin tocar. Depende de la decisión 7 de §7.
