...
**SIGUIENTE = Fase 4 inc. 2b:** PLANNED manual one-off (FAB sobre día seleccionado) → luego CRUD de plantillas + preset de lead. Después Fases 5 (inferencia bajo autorización) → 6 (espejo Google Calendar).
