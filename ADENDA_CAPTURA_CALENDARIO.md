...
**SIGUIENTE = Fase 4 inc. 2d:** preset de lead de recordatorio **global** en Perfil (`SettingsRepository.reminderLeadDays`: mismo día/1/2/3/7). Después Fases 5 (inferencia bajo autorización) → 6 (espejo Google Calendar).
