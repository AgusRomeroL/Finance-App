...
**SIGUIENTE = Fase 4 inc. 2c:** CRUD de plantillas recurrentes (`RecurrenceRepository`: lista activas + crear/editar cadencia/monto/fechas/lead con `AttributionShareEditor`; pausar/reanudar/eliminar) → luego inc. 2d (preset de lead en Perfil). Después Fases 5 (inferencia bajo autorización) → 6 (espejo Google Calendar).
