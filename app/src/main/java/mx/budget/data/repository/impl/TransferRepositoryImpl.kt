 ...
 * destino dentro de la misma transacción que persiste la transferencia.
 */
class TransferRepositoryImpl(
    ...
    /**
     * Aplica el efecto de un flujo de [amount] sobre [paymentMethodId].
     * Entrada (inflow): líquido SUBE saldo, crédito BAJA deuda. Salida: lo opuesto.
     */
